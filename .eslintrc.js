...
module.exports = {
  ...
  rules: {
    ...
    'eslint-comments/no-restricted-disable': [
      ...
      '!no-console',
      '!prettier',
      '!no-labels', // TODO: rewrite logic in github.user.service and remove no-lanels from this array
      '!max-lines-per-function', // TODO: remove max-lines-per-function from this array after addressing tech debt
    ],
