...
import { AppPortfolioLanguagesComponent } from './languages.component';

describe('AppPortfolioLanguagesComponent', () => {
  const testBedConfig: TestModuleMetadata = {
    declarations: [AppPortfolioLanguagesComponent, AppTestingComponent],
    imports: [
  ...
  let fixture: ComponentFixture<AppPortfolioLanguagesComponent>;
  let component: AppPortfolioLanguagesComponent;
  ...
  beforeEach(
    waitForAsync(() => {
      void TestBed.configureTestingModule(testBedConfig)
        .compileComponents()
        .then(() => {
          fixture = TestBed.createComponent(AppPortfolioLanguagesComponent);
